		...
		\chapter{Použité technologie}
			...
			\section{JavaScript}
				...
				\subsection{JSON}
					...
					Tento formát je velmi vhodný na přenos informací, jakými jsou data z wordnetu, jelikož se jedná o čistě textová data, odpověď, již lze jednoduše zpracovat v jazyce JavaScript, je také poměrně intuitivně lidsky čitelná. 
