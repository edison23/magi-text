...
% 
% - vsechny reference na kapitoly a casti by mely byt kursivou pres \itNameRef{}
...
% pripsat url rozhrani do kazde sekce
	...
	\label{part:zwei}
		...
		\chapter{Metodologie porovnání}
			...
			\section{Výběr rozhraní}
				...
				Pro účely porovnání (určení východiska, baseline) bude do popisu zahrnuto ještě jedno rozhraní, a to oficiální vyhledávací rozhraní princetonského WordNetu \footnote{\url{http://wordnetweb.princeton.edu/perl/webwn}}.
