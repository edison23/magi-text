...
\todo[inline]{TODO tady v~textu:}
	\todo[inline,backgroundcolor=red!25]{kontrola, ze pisu novym pravopisem ("responzivní místo responsivní") -- když narazíš na něco starým, prosím, flaguj/opravuj to}
	\todo[inline,backgroundcolor=red!25]{název rozhraní ještě není finální, nějaké nápady, jako ho vylepšit? (původní nápad Not So Fickle Wordnet viewer, momentálně Not Safe For Work wordnet viewer)}
		...
		\label{cha:porovnani}
			...
			\section{Vizulizace v~aplikačním prostředí Java}
				...
				\subsection{Visual Browser}
					...
					Visual Browser, dostupná z~\url{https://nlp.fi.muni.cz/projekty/visualbrowser/index.html}, je vizualizační aplikace poněkud obecnější, co se jejího účelu týče. Je schopna zobrazit strukturu wordnetu, kódu v~Javě či katalog knihovny. Má pouze vizualizační režim a používá jako zdroj dat soubory RDF\footnote{Resource Description Framework} a k~nim perspektivu v~XML, která umožňuje změnit způsob, jakým je na data nahlíženo. EuroWordNet tak může být zobrazen jako tezaurus či jako slovník díky tomu, že obsahuje více jazyků. \parencite{visualbrowser}\td{update autora na citaci} 
	...
	\label{part:drei}
		...
		\label{cha:navrh}
			...
			\section{Cíle nového rozhraní}
				...
				S touto vizí tedy byla vytvořena webová aplikace \simplywn (Not So Fickle Wordnet viewer), která ja v~dalších částech této práce prezentována.
