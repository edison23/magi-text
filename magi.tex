		...
		\label{cha:princeton_wn}
			...
			\section{Motivace vzniku}
				...
				\subsection{Od slovníků k WordNetu}
					...
					S touto myšlenkou vznikl WordNet -- lexikální síť provázaná sémantickými vztahy, která dle poznatků psycholingvistiky odráží uspořádání lexikálního materiálu v lidském mozku (více v kap. \itNameRef{cha:psycho} na straně \pageref{cha:psycho}). \parencite{pala2013vceska} 
