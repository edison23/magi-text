...
\begin{document}
	...
	\label{cha:dalsi_wordnety}
		...
		Podle vzoru princetonského WordNetu začaly postupně vznikat i další sémantické sítě založené na stejném konceptu. Tyto sémantické sítě se samozřejmě svou strukturou do menší či větší míry liší\td{nakou kurva citaci}, hlavním kritériem pro to, aby mohly být považovány za wordnet je to, aby obsahovaly synsety a hyponyma\td{http://globalwordnet.org/wordnets-in-the-world/}. Jelikož se tato práce bude primárně zabývat wordnetem českým, bude pro srovnání uvádět dva hlavní evropské vícejazyčené wordnety, a to Eurowordnet a Balkanet. 
