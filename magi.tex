...
% vymyslet, jak rozjet VisualBrowser nebo jeho nefunkcnost popsat diplomaticky (a smazat pak teda příkladem budiž Visual Browser zde rozebíraný)
...
\todo[inline]{TODO tady v textu:}
	\todo[inline,backgroundcolor=red!25]{kontrola, ze pisu novym pravopisem ("responzivní místo responsivní") -- když narazíš na něco starým, prosím, flaguj to}
	\todo[inline,backgroundcolor=red!25]{(christofe,) pomoc, jak rozjet Visual Browser, nefunguje mi ani s RDF z adresy na jeho webu}
	...
	\label{part:zwei}
		...
		\label{cha:porovnani}
			...
			\section{Vizulizace v aplikačním prostředí Java}
				...
				\subsection{VisualBrowser}

					\todo[inline]{napsat diplomaticteji, nebo se pokusit aplikaci rozjet poradne}

					Verze aplikace VisualBrowser, dostupná z \url{https://nlp.fi.muni.cz/projekty/visualbrowser}, testovaná v rámci této práce neprokázala dostatečnou intuitivitu a funkčnost, aby její vlastnosti mohly být dále rozebrány. 
