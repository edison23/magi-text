...
\begin{document}
	...
	\begin{titlepage}
		\begin{center}
			...
			{\LARGE\bf Vizualizace sémantické sítě}
	...
	\label{part:eins}
		...
		\label{cha:princeton_wn}
			...
			\label{cha:psycho}
				...
				Navzdory tomu, že je WordNet (a všeobecně wordnety) využíván převážně k úkolům počítačového zpracování jazyka, zdá se být pro svou podobnost v uspořádání informací vhodný i v jiných oblastech. Na příkladech již bylo ukázáno, že zkoumání významů a propojenosti konceptů v jazyce, s nímž není uživatel zcela obeznámen, by mohlo ve WordNetu být snazší než v klasickém slovníku. V podobném duchu využili při svých kursech WordNet například \textcite{lemnitzer2003using}.
