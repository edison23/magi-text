	...
	\part{Přehled a porovnání existujících vizualizací sémantických sítí}
		...
		\chapter{Metodologie porovnání}
			...
			\section{Výběr rozhraní}
				...
				Pro účely porovnání (určení východiska\td{well, baseline}) budou do popisu zahrnuta ještě dvě rozhraní, a to oficiální vyhledávací rozhraní princetonského WordNetu (\url{http://wordnetweb.princeton.edu/perl/webwn}) a slovníkové rozhraní na provozované Fakultou informatiky Masarykovy univerzity DEBDict (\url{https://deb.fi.muni.cz:8005/debdict/}).
			...
			\section{WordNet Search a DEBDict jako základ porovnání}
		...
		\chapter{Vizualizace s webovým rozhraním}
			...
			\section{An interactive visualization of the Princeton WordNet database}
				...
				% Rozhraní navíc nesplňuje základní pravidla webové dostupnosti kvůli tomu, že jej nelze ovládat pouze klávesnicí.
