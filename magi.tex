...
\begin{document}
	...
	\label{part:zwei}
		...
		\chaptermark{Shrnutí přehledu}
			...
			Aplikace vytvořené v Javě jsou sice teoreticky spustitelné i na některých mobilních operačních systémech (ja bylo zmíněno v reference1, prakticky je jejich použitelnost vzhledem k jejich designu grafického rozhraní omezena ale také výhradně na klasické počítače. 
