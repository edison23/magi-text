	...
	\part{Přehled a porovnání existujících vizualizací sémantických sítí}
		...
		\chapter{Metodologie porovnání}
			...
			\section{Výběr rozhraní}
				...
				Pro účely porovnání (určení východiska\td{well, baseline}) budou do popisu zahrnuta ještě jedno rozhraní, a to oficiální vyhledávací rozhraní princetonského WordNetu (\url{http://wordnetweb.princeton.edu/perl/webwn}). 
			...
			\label{wnvis:wnsearch}
				...
				\begin{figure}[h]
					\centering
					\includegraphics[width=0.8\textwidth]{wnsearch.png}
		...
		\chapter{Vizualizace s webovým rozhraním}
			...
			\label{wnvis:cornetto}
				...
				Cornetto Demo je prohlížeč pro nizozemský otevřený wordnet a jako jediný ze zde předkládaných aplikací kombinuje grafickou a textovou vizualizaci dat. 

				Rozhraní je rozděleno na tři moduly, jednoduché vyhledávání, pokročilé vyhledávání a vizualizace synsetů. V této práci bude rozebráno pouze jednoduché vyhledávání a vizualizace synsetů, jelikož pokročilé vyhledávání se během vzniku této práce nepodařilo dostatečně otestovat pro nedostatek odborníků na nizozemštinu a také lze bezpečně předpokládat, že povede na stejnou vizualizaci dat, jako hledání jednoduché. Jednoduché vyhledávání a vizualizace synsetů prezentují uživateli v zásadě tytéž vyhledávací formuláře, liší se pouze limitem zobrazených synsetů, který je v případě vizualizace ze zřejmých důvodů nastaven na jedna. Podstatnější rozdíl však tkví v tom, že tyto dva vyhledávací formuláře vedou na různé reprezentace dat. Jednoduché vyhledávání po odeslání formuláře zobrazí vyhledaná data v textové reprezentaci, zatímco vizualizace synsetů zobrazí graf s prvním nalezeným synsetem, vztahy, v nichž je přítomen, a příbuzné synsety. [to be continued]
